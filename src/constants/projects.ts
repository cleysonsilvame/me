export const projects = [
  {
    title: 'Github Blog',
    description:
      "Github Blog is an application developed during Rocketseat's Ignite React Challenge 03. The goal is to consume the Github API to list publications (issues) from a repository, display details of each publication, and allow searching for posts.",
    image:
